...
const s: Record<string, React.CSSProperties> = {
  ...
  avatar: { width: 56, height: 56, borderRadius: '50%', background: '#C8962E', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: 22, fontWeight: 700, flexShrink: 0 },
  ...
  progressFill: { height: '100%', background: '#C8962E', borderRadius: 3, transition: 'width 0.3s' },
