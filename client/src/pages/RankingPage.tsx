...
const styles: Record<string, React.CSSProperties> = {
  ...
  row: { display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', backgroundColor: '#fff', borderRadius: 10, border: '1px solid #f0f0f5', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' },
  ...
  avatar: { width: 36, height: 36, borderRadius: '50%', backgroundColor: '#f0f0f5', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, overflow: 'hidden' },
  avatarImg: { width: '100%', height: '100%', objectFit: 'cover' },
  avatarText: { fontSize: 14, fontWeight: 700, color: '#a0aec0' },
  info: { flex: 1 },
  nickname: { fontSize: 14, fontWeight: 600, color: '#2d3748' },
  score: { fontSize: 14, fontWeight: 700, color: '#667eea', flexShrink: 0 },
  myRank: { display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', backgroundColor: '#ebf8ff', border: '1px solid #bee3f8', borderRadius: 10, marginBottom: 20 },
  myRankLabel: { fontSize: 12, fontWeight: 700, color: '#2b6cb0', flexShrink: 0 },
  myRankInfo: { fontSize: 14, fontWeight: 600, color: '#2d3748' },
};
